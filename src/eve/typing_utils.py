...
# def monkey_patch_as_subscriptable(cls):
...
# while not done:
#     try:
#         tp = typing.get_type_hints(A, globalns=globalns)
#         done = True
#     except NameError as e:
#         ConcreteMissingRef = type(f"__{e.name}__MissingRef", (__MissingRef,), dict(name=e.name))
#         new_missing_refs.append(ConcreteMissingRef)
#         globalns[e.name] = ConcreteMissingRef
#     except TypeError as e:
#         assert new_missing_refs
